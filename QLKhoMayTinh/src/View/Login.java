...
public class Login extends javax.swing.JFrame {
    ...
    private NhanVienFileController nvfile = new NhanVienFileController();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(35, 35, 35)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(manv, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(matkhau, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(305, 305, 305)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        File file = new File("src\\FileData\\NHANVIEN.txt");
        nhanViens = nvfile.readNhanVienFromFile(file.getAbsolutePath());
        String ma = manv.getText();
        String passWord = matkhau.getText();
            int check = 0;
            for (NhanVien nv : nhanViens) {
                if (ma.compareToIgnoreCase(nv.getMa()) == 0 && passWord.compareToIgnoreCase(nv.getMatKhau()) == 0) {
                    NhanVien a = nv;
                    check = 1;
            ...
            if (check == 0) {
                JOptionPane.showMessageDialog(this, "Sai mã nhân viên hoặc mật khẩu, vui lòng nhập lại");
            }
